...
//todo external configuration variable instead of value
        ...
        {
           jsCode='console.log("Commands: Add User $username - adds users to allowed users list Remove User $username -removes users from the allowed users list Deploy $branch -- it deploys on feature4 the specified branch  Jenkins jenkinsUrl ")' 
        }
