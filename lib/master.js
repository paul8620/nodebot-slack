...
//todo external configuration variable instead of value
        ...
        {
           jsCode='console.log("Commands:\nAdd User $username - adds users to allowed users list\nRemove User $username -removes users from the allowed users list\nDeploy $branch -- it deploys on feature4 the specified branch\n Jenkins jenkinsUrl \n")' 
        }
